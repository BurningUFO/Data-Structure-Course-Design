...
| 校园节点（pku_001 ~ pku_005，新增） | 标准分层图节点 ID | 已映射到当前 PKU 标准分层图，支持真实距离计算 |
...
|----|------|-------------|
| pku_001 | 图书馆 | library |
| pku_002 | 第一教学楼 | teaching_building_1 |
| pku_003 | 学生宿舍1 | dormitory_1 |
| pku_004 | 校内便利店 | convenience_store |
| pku_005 | 北门 | gate_north |
